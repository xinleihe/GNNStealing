...
def prepare_datasets(config):
    ...
    if config['data_type'] == 'network':
        ...
        adj, features, labels, idx_train, idx_val, idx_test = network_data_utils.load_dgl_graph(config['dgl_graph'], 
                                                                                                knn_size=config.get('input_graph_knn_size', None), 
                                                                                                epsilon=config.get('input_graph_epsilon', None), 
                                                                                                knn_metric=config.get('knn_metric', 'cosine'), 
                                                                                                prob_del_edge=config.get('prob_del_edge', None), 
                                                                                                prob_add_edge=config.get('prob_add_edge', None), 
